...
export default class GamePlay {
  ...
  drawUi(theme) {
    ...
    this.popupCloseBtn = document.querySelector('.popup__button');

    this.level = this.container.querySelector('.level');
    this.steps = this.container.querySelector('.steps');
    this.points = this.container.querySelector('.points');
    this.bestResult = this.container.querySelector('.best-result');

    this.newGameEl.addEventListener('click', (event) => this.onNewGameClick(event));
    this.saveGameEl.addEventListener('click', (event) => this.onSaveGameClick(event));
    this.loadGameEl.addEventListener('click', (event) => this.onLoadGameClick(event));
    this.popupCloseBtn.addEventListener('click', () => GamePlay.closePopup());
